...
### After each run in hadoop hdfs, please remove the folder named as "intermediate" since it gets created everytime you run the whotofollow jar. Also make sure that either the folder name given to the output directory does not exist in the hdfs.
